...
class MatchAndChatsReportFLDController extends MyController {
  List<AppointmentListModel> matchAndChatList = [];
  ...
  int get totalPages => (matchAndChatList.length / selectPageLength).ceil();
  int get startIndex => selectedIndex * selectPageLength;
  int get endIndex => (startIndex + selectPageLength).clamp(0, matchAndChatList.length);
