...
class NotificationController extends MyController {
  ...
  TextEditingController toastTitleController = TextEditingController(text: "Hello Users");
  TextEditingController toastBodyController = TextEditingController(text: "BooBud new update available");
