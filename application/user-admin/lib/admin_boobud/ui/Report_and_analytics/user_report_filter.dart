...
import 'package:medicare/admin_boobud/controller/Report_and_analytics/report_and_analytics_add_controller.dart';
...
class UserReportFilterScreen extends StatefulWidget {
  const UserReportFilterScreen({super.key});

  @override
  State<UserReportFilterScreen> createState() => UserReportFilterScreenState();
}

class UserReportFilterScreenState extends State<UserReportFilterScreen> with UIMixin {
  late UserReportFilterController controller;

  @override
  void initState() {
    controller = Get.put(UserReportFilterController());
    super.initState();
  }
