...
import 'package:medicare/admin_boobud/controller/Report_and_analytics/book_report/book_report_controller.dart';
...
class BookReportFLDScreen extends StatefulWidget {
  const BookReportFLDScreen({super.key});

  @override
  State<BookReportFLDScreen> createState() => BookReportFLDScreenState();
}

class BookReportFLDScreenState extends State<BookReportFLDScreen> with UIMixin {
  BookReportFLDController controller = Get.put(BookReportFLDController());
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: 'Book Reports', active: true),
                      ],
                    ),
                  ],
                ),
                    ...
                    children: [
                      ...
                      if(controller.isView)
                        SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              if (controller.bookReportList.isNotEmpty)
                                Row(
                                  children: [
                                    _widgetTableHeadBox(-1, 150, "ID", isFirst: true),
                                    _widgetTableHeadBox(-1, 200, "Book Name"),
                                    _widgetTableHeadBox(-1, 300, "book Author Email"),
                                    _widgetTableHeadBox(-1, 250, "book Author Mobile Number"),
                              ...
                              index++)
                                Row(
                                  children: [
                                    _widgetTableBody(index, 150, controller.bookReportList[index].id.toString(), isFirst: true),
                                    _widgetTableBody(index, 200, controller.bookReportList[index].name.toString()),
                                    _widgetTableBody(index, 300, controller.bookReportList[index].email.toString()),
                                    _widgetTableBody(index, 250, controller.bookReportList[index].mobile.toString()),
                                    _widgetTableBody(index, 220, Utils.getDateStringFromDateTime(controller.bookReportList[index].date, showMonthShort: true)),
                                    _widgetTableBody(index, 220, Utils.getTimeStringFromDateTime(controller.bookReportList[index].date, showSecond: false),isLast: true),
                                ...
                                MyFlexItem(
                                  ...
                                  child: MyContainer(
                                    ...
                                    child: MyText.titleMedium(
                                        "Showing : 1-10 of 1201 Book Data",
  ...
  Widget filterReportDetail() {
    return MyFlex(contentPadding: false, children: [
      MyFlexItem(
          sizes: 'lg-6 md-6',
          child: commonTextField(title: "Book Name", hintText: "Please Enter Book Name", prefixIcon: Icon(Icons.person, size: 16))),
      MyFlexItem(
          sizes: 'lg-6 md-6',
          child: commonTextField(title: "Book Id", hintText: "Please Enter Book Id", prefixIcon: Icon(Icons.person, size: 16))),
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: "Date of Start Book Report",
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                  hintText: "Date of End Book Report",
                  hintStyle: MyTextStyle.bodySmall(fontWeight: 600, muted: true),
                  isCollapsed: true,
                  isDense: true,
                  prefixIcon: Icon(LucideIcons.calendar),
