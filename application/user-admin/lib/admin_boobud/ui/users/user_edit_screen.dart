...
class UserEditScreenState extends State<UserEditScreen> with UIMixin {
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: 'User List'),
                        MyBreadcrumbItem(name: 'User Edit', active: true),
                      ],
                    ),
                  ],
                ),
              ...
              Padding(
                ...
                child: MyContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      MyText.titleMedium("User Information", fontWeight: 600),
                      MySpacing.height(20),
                      MyFlex(
                          ...
                          MyFlexItem(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                MySpacing.height(20),
                                commonTextField(title: "User Email", hintText: "User Email", prefixIcon: Icon(Icons.mail_outline_rounded, size: 16), teController: controller.email),
                                MySpacing.height(20),
