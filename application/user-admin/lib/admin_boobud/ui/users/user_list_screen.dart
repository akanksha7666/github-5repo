import 'package:medicare/admin_boobud/controller/users/user_list_controller.dart';
...
class _UserListScreenState extends State<UserListScreen> with UIMixin {
  UserListController controller = Get.put(UserListController());
  @override
  Widget build(BuildContext context) {
    Debug.printLog("Screen Width is :- ${MediaQuery.of(context).size.width.toString()}");
    return Layout(
      child: GetBuilder(
        init: controller,
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          MyText.bodyMedium("User Management", fontWeight: 600, muted: true),
                          Spacer(),
                            ...
                            if (controller.userModelList.isNotEmpty)
                              Row(
                                children: [
                                  ...
                                  _widgetTableHeadBox(-1, 220, "Verification Status"),
                            ...
                            index++)
                              Row(
                                children: [
                                  ...
                                  _widgetTableBody(index, 220, controller.userModelList[index].verificationStatus.toString()),
