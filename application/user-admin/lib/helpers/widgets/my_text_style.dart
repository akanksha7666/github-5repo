...
class MyTextStyle {
  ...
  static TextStyle bodyErrorFiled(
      {TextStyle? textStyle,
      int fontWeight = 500,
      bool muted = false,
      bool xMuted = false,
      ...
      double? fontSize}) {
    return getStyle(
        fontSize: fontSize ?? _defaultTextSize[MyTextType.errorSmall],
        color: color,
        height: height,
        muted: muted,
        letterSpacing: letterSpacing ?? _defaultLetterSpacing[MyTextType.errorSmall],
        fontWeight: _defaultTextFontWeight[MyTextType.errorSmall],
        decoration: decoration,
        textStyle: textStyle,
        wordSpacing: wordSpacing,
        xMuted: xMuted);
