...
class AppTheme {
  ...
  static Color primaryColor = Color(0xffFCDA88);
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      seedColor: Color(0xffFCDA88), // This seed color will generate a harmonious color scheme
      primary: Color(0xff1470AF),   // Set Primary Color
      secondary: Color(0xff6C757D), // Set Secondary Color
      tertiary: Color(0xff00be82),  // Custom tertiary color (optional)
  ...
  static final ThemeData darkTheme = ThemeData.dark(useMaterial3: false).copyWith(
    ...
    /// Colorscheme
    colorScheme: ColorScheme.fromSeed(
      primary: Color(0xff1470AF),
      seedColor: Color(0xffFCDA88),
...
class AppStyle {
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem: MyBreadcrumbItem(name: 'BooBud', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
