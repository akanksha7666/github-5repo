...
class LeftBarTheme {
  ...
  LeftBarTheme({
    ...
    this.activeItemColor = const Color(0xff1470AF),
    this.activeItemBackground = const Color(0xffFCDA88),
  });
  ...
  static final LeftBarTheme darkLeftBarTheme = LeftBarTheme(
      ...
      activeItemBackground: const Color(0xffFCDA88),
      activeItemColor: const Color(0xff1470AF));
}
...
class RightBarTheme {
  ...
  RightBarTheme({
    ...
    this.activeSwitchBorderColor = const Color(0xff1470AF),
  ...
  static final RightBarTheme lightRightBarTheme = RightBarTheme(
      ...
      activeSwitchBorderColor: const Color(0xff1470AF),
...
class ContentTheme {
  ...
  ContentTheme({
    this.primary = const Color(0xff1470AF),
    this.secondary = const Color(0xffFCDA88),
  ...
  static final ContentTheme lightContentTheme = ContentTheme(
    primary: Color(0xff1470AF), // Change this to your desired primary color
    secondary: Color(0xffFCDA88),
  ...
  static final ContentTheme darkContentTheme = ContentTheme(
    primary: Color(0xffFCDA88), // Change this to your desired primary color
    secondary:  Color(0xff1470AF) ,
